    ...
    <div class="col-md-12">
      <div class="card card-user">
        <div class="card-header">
          <div class="toolbar">
            <a href="<?=base_url()?>index.php/kepala_lab/inventaris"><button class="btn btn-primary"><i class="fa fa-arrow-circle-left"></i> &nbsp; Kembali ke Data Inventaris</button></a>
          </div>
          <h5 class="card-title">Tambah Inventaris</h5>
        </div>
        <div class="card-body">
          <form class="form-horizontal" action="<?=base_url()?>index.php/kepala_lab/inventaris/create/do_create" method="post" enctype="multipart/form-data">
            <div class="row">
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <form class="form-horizontal" action="<?=base_url()?>index.php/kepala_lab/inventaris/insert_jenis_barang" method="post">

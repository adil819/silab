          ...
          <div class="col-md-12">
            <div class="card card-user">
              <div class="card-header">
                <div class="toolbar">
                  <a href="<?=base_url()?>index.php/admin/media"><button class="btn btn-primary"><i class="fa fa-arrow-circle-left"></i> &nbsp; Kembali ke Data Media</button></a>
                </div>
                <h5 class="card-title">Edit Media</h5>
              </div>
              <div class="card-body">
                <form class="form-horizontal" action="<?=base_url()?>index.php/admin/media/update/<?=$row->media_id?>/do_update" method="post" enctype="multipart/form-data">
                  <div class="row">
                      ...
                      <div class="form-group">
                        <select class="form-control" id="kategori" name="media_med_kat_id" required>
                          ...
                          <?php foreach ($kategori as $key): ?>
                            <option value="<?=$key->med_kat_id?>" <?php if($row->media_med_kat_id == $key->med_kat_id) echo "selected"?> >
                              <?=$key->med_kat_name?>
                            </option>  
                          <?php endforeach ?>
                        </select>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-10">
                      <div class="form-group">
                        <input type="text" class="form-control" name="media_judul" value="<?=$row->media_judul?>" required>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                      ...
                      <div class="form-group">
                        <div class="fileinput fileinput-exists text-center" data-provides="fileinput">
                          ...
                          <div class="fileinput-preview fileinput-exists thumbnail">
                            <img src="<?=base_url()?>assets/img/media/<?=$row->media_gambar?>">
                          </div>
                          <div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-10">
                      <div class="form-group">
                        <textarea id="editor1" rows="10" cols="80" name="media_isi"><?=$row->media_isi?></textarea>
                      </div>
                    </div>
                  </div>
                  <div class="row">

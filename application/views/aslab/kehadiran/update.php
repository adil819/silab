   ...
   <div class="col-md-12">
    ...
    <div class="toolbar">
     ...
     <button class="btn btn-primary"><i class="fa fa-arrow-circle-left"></i> &nbsp; Kembali ke Mata Kuliah</button></a>
      ...
      <div class="row">
      <form action="<?=base_url()?>index.php/aslab/kehadiran/update/do_update/<?=$key->nim?>"  id="signupForm" method="post">
        <div class="col-sm-6">
    ...
    <div class="modal-footer justify-content-center">
     <!--  <div class="left-side">
        <button type="button" class="btn btn-default btn-link" a href="<?php echo base_url();?>index.php/aslab/kehadiran/">Batal</button>
      </div> -->

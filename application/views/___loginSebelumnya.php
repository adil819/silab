	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<a href="<?php echo base_url()?>index.php/home/login_admin" class="login100-form-btn">Admin</a><br>
				<a href="<?php echo base_url()?>index.php/home/login_aslab" class="login100-form-btn">Aslab</a><br>
				<a href="<?php echo base_url()?>index.php/home/login_dosen" class="login100-form-btn">Dosen</a><br><br><br>
				<a href="<?php echo base_url()?>" class="login100-form-btn">Back</a>
				</div>	
			</div>
		</div>
	</div>
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="<?php echo base_url()?>index.php/admin/kelas" method="POST">
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						<span class="label-input100">NIM</span>
						<input class="input100" type="text" name="nim" id="username" placeholder="Enter NIM">
					...
					<div class="flex-sb-m w-full p-b-30">
						...
						<button type="submit" class="login100-form-btn">
							Login
						</button><a href="<?php echo base_url();?>index.php/home/login" class="login100-form-btn">Back</a>				
				</form>

...
class Search extends CI_Controller {
	...
	public function __construct()
  	{   	
		...
		$this->load->model('dosen/search_model', 'dbObject');
  	}
	...
	public function index()
	{
		...
		$this->load->view('dosen/search/index', $data);
	...
	public function detail($nim)
	{
		...
		foreach ($data['kelas'] as $key => $value) {
			...
			$data['dosen'][$value->id_kelas] = $this->dbObject->get_dosen($value->nidn);
		...
		$this->load->view('dosen/search/detail', $data);
	}
}
